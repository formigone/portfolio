...
<img title="composite-pattern-uml" src="/images/composite-pattern-uml.png" alt="" width="100%" />
...
<img title="composite-pattern-example" src="/images/composite-pattern-example.png" alt="" width="100%" />
